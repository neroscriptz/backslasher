...
loadstring(game:HttpGet("https://pastebin.com/raw/muf6ALr9", true))()
...
local Script = {
    Name = "backslasher.cc" --\\ This is used for notification.
}
local Misc = {
...
watermark_module.name = "backslasher.cc"
...
local lib = actualLib:Load({name = "backslasher.cc", sizeX = 425, sizeY = 510, color = Color3.fromRGB(37, 15, 134)})
-- \\ T510
...
Info:Label("backslasher.cc")
Info:Label("build: NAN*")
Info:Button {
    Name = "made by backslasha",
}
Info:Button {
    Name = "beta version!!! no leaking pls!!!",
}
...
WTRMARK:Box {
    Name = "dont touch plsss",
    Default = "backslasher.cc | user status : "..CheckStatus(game.Players.LocalPlayer.Name).."",
